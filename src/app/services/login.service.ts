...
export class LoginService {
  ...
  private productNameURL = 'https://ec2-3-16-206-59.us-east-2.compute.amazonaws.com:9095/login'; //URL to web api
  ...
  postLogin(login: Usuario) {
    let url = 'https://ec2-3-16-206-59.us-east-2.compute.amazonaws.com:9095/login'
